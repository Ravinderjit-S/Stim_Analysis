...
blink_proj = [Projs[0], Projs[2]]

data_eeg.add_proj(blink_proj)
data_eeg.plot_projs_topomap()
data_eeg.plot(events=data_evnt,show_options=True)
...
dat_epochs_1 = epochs_1.get_data(picks=picks)
dat_epochs_2 = epochs_2.get_data(picks=picks)
dat_epochs_3 = epochs_3.get_data(picks=picks)
dat_epochs_4 = epochs_4.get_data(picks=picks)
dat_epochs_5 = epochs_5.get_data(picks=picks)
dat_epochs_6 = epochs_6.get_data(picks=picks)
dat_epochs_7 = epochs_7.get_data(picks=picks)
dat_epochs_8 = epochs_8.get_data(picks=picks)

dat_epochs_1 = dat_epochs_1[:,:,t1:t2].squeeze().T
dat_epochs_2 = dat_epochs_2[:,:,t1:t2].squeeze().T
dat_epochs_3 = dat_epochs_3[:,:,t1:t2].squeeze().T
dat_epochs_4 = dat_epochs_4[:,:,t1:t2].squeeze().T
dat_epochs_5 = dat_epochs_5[:,:,t1:t2].squeeze().T
dat_epochs_6 = dat_epochs_6[:,:,t1:t2].squeeze().T
dat_epochs_7 = dat_epochs_7[:,:,t1:t2].squeeze().T
dat_epochs_8 = dat_epochs_8[:,:,t1:t2].squeeze().T
...
PLV_7, Coh_7, f = sa.PLV_Coh(target_mods[3,:], dat_epochs_7, TW, fs)
PLV_8, Coh_8, f = sa.PLV_Coh(target_mods[3,:], dat_epochs_8, TW, fs)
