...
#%% Blink Removal
blinks = find_blinks(data_eeg,ch_name = ['A1'],thresh = 100e-6, l_trans_bandwidth = 0.15, l_freq =1.0)
...
data_eeg.plot(events=blink_epochs,show_options=True)
...
epochs_9 = mne.Epochs(data_eeg,data_evnt,[9],tmin=tmin,tmax=tmax,
                              baseline=baseline,reject=reject)
...
dat_epochs_9 = epochs_9.get_data()
...
dat_epochs_9 = dat_epochs_9[:,:,t1:t2].squeeze().T
