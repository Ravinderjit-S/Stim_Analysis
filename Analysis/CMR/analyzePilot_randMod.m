...
Sig_4_p0 = load('CMR_SigAM_10coh_1.mat');
Sig_40_p0 = load('CMR_SigAM_40coh_1.mat');
Sig_223_p0 = load('CMR_SigAM_132coh_1.mat');

Sig_4_p180 = load('CMR_SigAM_10coh_0.mat');
Sig_40_p180 = load('CMR_SigAM_40coh_0.mat');
Sig_223_p180 = load('CMR_SigAM_132coh_0.mat');
...
CMR(1) = MedianSNR(1) - MedianSNR(4);
CMR(2) = MedianSNR(2) - MedianSNR(5);
CMR(3) = MedianSNR(3) - MedianSNR(6);
