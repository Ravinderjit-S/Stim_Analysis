...
rng(OldSeed);
% rand('state',OldSeed);%M.S. 2017 replaced with a call to rng(OldSeed) as
% per matlab documentation for new release
% randn('state',OldSeed);;%M.S. 2017 replaced with a call to rng(OldSeed) as
% per matlab documentation for new release
