...
data_eeg,data_evnt = EEGconcatenateFolder(data_loc + 'click_80' + '\\' ,nchans,refchans,exclude)
...
data_eeg,data_evnt = EEGconcatenateFolder(data_loc + 'click_70' + '\\' ,nchans,refchans,exclude)
data_eeg.filter(300,3000)
epochs = mne.Epochs(data_eeg,data_evnt,[255],tmin=-0.005,tmax=0.01)
evoked_70 = epochs.average()
evoked_70.plot(picks=channels, titles = '70')

data_eeg,data_evnt = EEGconcatenateFolder(data_loc + 'click_60' + '\\' ,nchans,refchans,exclude)
data_eeg.filter(300,3000)
epochs = mne.Epochs(data_eeg,data_evnt,[255],tmin=-0.005,tmax=0.01)
evoked_60 = epochs.average()
evoked_60.plot(picks=channels, titles = '60')

data_eeg,data_evnt = EEGconcatenateFolder(data_loc + 'click_50' + '\\' ,nchans,refchans,exclude)
data_eeg.filter(300,3000)
epochs = mne.Epochs(data_eeg,data_evnt,[255],tmin=-0.005,tmax=0.01)
evoked_50 = epochs.average()
evoked_50.plot(picks=channels, titles = '50')

data_eeg,data_evnt = EEGconcatenateFolder(data_loc + 'click_40' + '\\' ,nchans,refchans,exclude)
data_eeg.filter(300,3000)
epochs = mne.Epochs(data_eeg,data_evnt,[255],tmin=-0.005,tmax=0.01)
evoked_40 = epochs.average()
evoked_40.plot(picks=channels, titles = '40')

data_eeg,data_evnt = EEGconcatenateFolder(data_loc + 'click_30' + '\\' ,nchans,refchans,exclude)
data_eeg.filter(300,3000)
epochs = mne.Epochs(data_eeg,data_evnt,[255],tmin=-0.005,tmax=0.01)
evoked_30 = epochs.average()
evoked_30.plot(picks=channels, titles = '30')

data_eeg,data_evnt = EEGconcatenateFolder(data_loc + 'click_20' + '\\' ,nchans,refchans,exclude)
data_eeg.filter(300,3000)
epochs = mne.Epochs(data_eeg,data_evnt,[255],tmin=-0.005,tmax=0.01)
evoked_20 = epochs.average()
evoked_20.plot(picks=channels, titles = '20')

data_eeg,data_evnt = EEGconcatenateFolder(data_loc + 'click_10' + '\\' ,nchans,refchans,exclude)
data_eeg.filter(300,3000)
epochs = mne.Epochs(data_eeg,data_evnt,[255],tmin=-0.005,tmax=0.01)
evoked_10 = epochs.average()
evoked_10.plot(picks=channels, titles = '10')

data_eeg,data_evnt = EEGconcatenateFolder(data_loc + 'click_0' + '\\' ,nchans,refchans,exclude)
data_eeg.filter(300,3000)
epochs = mne.Epochs(data_eeg,data_evnt,[255],tmin=-0.005,tmax=0.01)
