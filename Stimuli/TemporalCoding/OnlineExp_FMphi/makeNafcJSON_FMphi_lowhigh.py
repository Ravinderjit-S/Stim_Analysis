...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 17:05:54 2020
...
json_fname = 'FMphi_' + str(FM) + '_' + low_high + '.json'
...
folder_path = '/OnlineStimWavs/FMphi/FMphi_' + str(FM) + '_' + low_high # Path to folder in dropbox
...
trial_choices = ['A', 'B', 'C']
stim_info_file = loadmat('StimData_' + str(FM) + '_' + low_high + '.mat')
