...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 19 23:32:24 2020
...
folder_path = '/OnlineStimWavs/FMphi/FMphi_' + str(FM) # Path to folder in dropbox
...
trial_choices = ['A', 'B', 'C']
stim_info_file = loadmat('StimData_' + str(FM) + '.mat')
