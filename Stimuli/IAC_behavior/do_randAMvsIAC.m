...
Trials_perFMrange = 30;
Low_FMs = 1+randi(9,[1,Trials_perFMrange]);%1-10
Mid_FMs = 10+randi(10,[1,Trials_perFMrange]);%11-20
Mid2_FMs = 20+randi(10,[1,Trials_perFMrange]);%21-30
High_FMs = 30+randi(10,[1,Trials_perFMrange]);%31-40
FMs_test = [Low_FMs,Mid_FMs,Mid2_FMs,High_FMs];
...
save([subj '_randAMvsIAC.mat'],'FMs','ntrials','respList','correctList')
