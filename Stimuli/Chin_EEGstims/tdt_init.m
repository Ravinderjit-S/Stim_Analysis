function [RP1, RP2, PA5_1,PA5_2,PA5_3,PA5_4,tdt_info] = tdt_init(fig_num)
...
RP1 = actxcontrol('RPco.x',fig_loc,f1);
status(1) = RP1.ConnectRP2(tdt_info.TDTcommMode,1);

RP2 = actxcontrol('RPco.x',fig_loc,f1);
status(2) = RP2.ConnectRP2(tdt_info.TDTcommMode,2);

PA5_1 = actxcontrol('PA5.x',fig_loc);
status(3) = PA5_1.ConnectPA5(tdt_info.TDTcommMode,1);

PA5_2 = actxcontrol('PA5.x',fig_loc);
status(4) = PA5_2.ConnectPA5(tdt_info.TDTcommMode,2);

PA5_3 = actxcontrol('PA5.x',fig_loc);
status(5) = PA5_3.ConnectPA5(tdt_info.TDTcommMode,3);

PA5_4 = actxcontrol('PA5.x',fig_loc);
status(6) = PA5_4.ConnectPA5(tdt_info.TDTcommMode,4);
...
% NOTE: When RX8 is back, setup its connection. Also update circuit file
% for RX8
